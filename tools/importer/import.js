...
const createHero = (main, document, newMain) => {
...
const createGrids = (main, document, newMain) => {

  // Find all aem-GridColumn--default--6 that are children of aem-Grid--12
  const cols = main.querySelectorAll('div.aem-Grid--12 > div.aem-GridColumn--default--6');
  let newCols = [];
...
export default {
  ...
  transformDOM: async ({
    ...
    createGrids(main, document, newMain);
